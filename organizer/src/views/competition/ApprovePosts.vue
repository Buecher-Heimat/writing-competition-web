...
<template>
    <div class="px-10">
        <h1 class="my-10 font-bold text-2xl font-serif small-caps text-twine-400">Texte prüfen</h1>
        <div v-if="store.pendingPosts.length > 0">
        ...
        <div v-else>
            <p>Es gibt keine Texte, die auf Freischaltung warten.</p>
        </div>
    </div>
</template>