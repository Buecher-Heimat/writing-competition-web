...
<template>
  <router-link
    :to="`/wettbewerb/${competition.slug}`"
    class="bg-pearl-bush-50 p-5 rounded-lg shadow-md flex gap-5"
  >
    <div v-if="(competition.image_hero as Media).url">
      <img
        :src="environment.backendUrl + (competition.image_hero as Media).url!"
        alt="Bild des Wettbewerbs"
